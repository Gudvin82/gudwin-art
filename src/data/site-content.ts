...
export const stylePresets: StylePreset[] = [
  ...
  },
  {
    ...
    description: { ru: 'Античные мотивы, мрамор и тёплые песочные тона.', en: 'Classical motifs, marble and warm sand tones.' },
    preview: '/examples/pet-3.jpg',
    promptTemplate: 'ancient world pet portrait, classical fresco style, marble background, warm sandstone palette',
  },
  {
    id: 'baroque-pet',
    mode: 'pets',
    ...
    description: { ru: 'Пышные ткани, золото и драматичный свет.', en: 'Rich fabrics, gold accents and dramatic light.' },
    preview: '/examples/pet-1.jpg',
    promptTemplate: 'baroque pet portrait, ornate costume, dramatic chiaroscuro, rich gold details',
  },
  {
  ...
  },
  {
    ...
    epoch: 'ancient',
    title: { ru: 'Древний мир', en: 'Ancient World' },
    description: { ru: 'Античная эстетика фресок и монументальная композиция.', en: 'Ancient fresco aesthetics and monumental composition.' },
    preview: '/examples/human-3.jpg',
    promptTemplate: 'ancient world family portrait, fresco painting, marble columns, classical drapery',
  },
  {
    id: 'baroque-family',
    mode: 'humans',
    epoch: 'baroque',
    title: { ru: 'Барокко', en: 'Baroque' },
    description: { ru: 'Парадный портрет с роскошными деталями и контрастом света.', en: 'Ceremonial portrait with ornate details and strong light contrast.' },
    preview: '/examples/human-1.jpg',
    promptTemplate: 'baroque family portrait, ornate costumes, dramatic lighting, rich textures',
  },
];
